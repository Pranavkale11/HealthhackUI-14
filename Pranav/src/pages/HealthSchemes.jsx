...
const SCHEMES = [
  ...
  },
  {
    title: "CGHS",
    tag: "Central",
    img: "https://d28c6jni2fmamz.cloudfront.net/CT_FEB_002_Images_for_Government_Scheme_Pages_3_d2b132cd30.jpg",
    desc:
  ...
  },
  {
    ...
    tag: "Maternal",
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOC0Zg8i52z2XK6lJ4OhrT9kQaZ87AWPFUuw&s",
    desc:
  ...
  },
  {
    ...
    tag: "Maternal",
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYN3zWezRVGBTG0k1td4OHsCFM2D9ACDweDw&s",
    desc:
  ...
  },
  {
    ...
    tag: "Immunization",
    img: "https://ehealth.eletsonline.com/wp-content/uploads/2018/01/Mandsaur-mp-The-second-phase-of-the-rainbow-mission-until-December-7-to-14-news-in-hindi-119724.png",
    desc:
  ...
  },
  {
    ...
    tag: "Child Health",
    img: "https://www.impactguru.com/info/wp-content/uploads/2023/04/Rashtriya-Bal-Swasthya-Karyakram-RBSK-1200-x-800.jpg",
    desc:
  ...
  },
  {
    ...
    tag: "Chronic Care",
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsKP5_EPONAybNWbmltkdV2aJBUxEQnEfFUg&s",
    desc:
  ...
  },
  {
    ...
    tag: "Maternal",
    img: "https://i0.wp.com/ketto.blog/wp-content/uploads/2024/01/Pradhan-Mantri-Surakshit-Matritva-Abhiyan-PMSMA.jpg?fit=1024%2C576&ssl=1",
    desc:
  ...
  },
  {
    ...
    tag: "Primary Care",
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5Fa0sV0WfKxqJ3kZd5DgwWT_dCNEN7ChoNA&s",
    desc:
  ...
  },
  {
    ...
    tag: "State",
    img: "https://cdn.zeebiz.com/sites/default/files/2022/05/29/184147-govt-schemes.jpg",
    desc:
      "State-specific schemes (e.g., TN CM Health, Bhamashah, Aarogyasri) for resident families.",
  },
  {
    title: "Wellness & Preventive Programs",
    tag: "General",
    img: "https://i0.wp.com/www.opindia.com/wp-content/uploads/2018/03/Children-Celebrating-International-Yoga-Day-Picture.jpg?fit=696%2C463&ssl=1",
    desc:
      ...
      <div className="grid md:grid-cols-[1fr,320px] gap-8 items-start">
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            {["All", "Central", "State", "Insurance", "Low-income", "Maternal", "Child Health", "Immunization", "Chronic Care", "Primary Care", "General"].map(
              (x, i) => (
                <button
                  key={i}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 flex items-center justify-between text-xs">
                    ...
                    <span className="px-2 py-1 rounded bg-green-600 text-white cursor-pointer">
                      More
                    </span>
                  </div>
                </div>
