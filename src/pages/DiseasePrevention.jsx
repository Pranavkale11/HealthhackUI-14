// src/pages/DiseasePrevention.jsx
      ...
      <div className="grid md:grid-cols-[1fr,320px] gap-8 items-start">
        ...
        <div>
          ...
          <p className="text-gray-700 mt-3 max-w-2xl">
            ...
            and in future we will bring more so that it would be more beneficial
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            {["All", "Vector-Born", "Non-Communicable", "Communicable", "Environmental"].map(
              (x, i) => (
                <button
                  key={i}
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            ...
            <Link
              to="/malaria-risk"
              className="block bg-white shadow rounded-xl overflow-hidden border hover:shadow-lg transition"
            >
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Life-threatening disease caused by parasites.
                </p>
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  A group of diseases affecting blood sugar.
                </p>
                <div className="mt-3 flex items-center justify-between text-xs">
                  <span className="px-2 py-1 rounded bg-purple-100 text-purple-700">
                    Non-Communicable
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Infection of the intestines leading to loose stool.
                </p>
                <div className="mt-3 flex items-center justify-between text-xs">
                  <span className="px-2 py-1 rounded bg-purple-100 text-purple-700">
                    Communicable
